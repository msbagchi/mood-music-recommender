...
(function initCursor() {
    ...
    if (!dot || !ring) { setTimeout(initCursor, 100); return; }
    ...
    document.addEventListener('mousedown', function(e) {
        ...
        for (var i = 0; i < 14; i++) spawnBurstBubble(mx, my);
    });
    ...
    function animateRing() {
        ...
        var l = 65 + Math.sin(Date.now() * 0.003) * 10;
    ...
    function spawnBubble(x, y) {
        ...
        var h = 220 + Math.floor(Math.random() * 20 - 10);
        var s = 80 + Math.floor(Math.random() * 15);
        var l = 65 + Math.floor(Math.random() * 15);
        var dur = (Math.random() * 0.5 + 0.8).toFixed(2);
        b.style.cssText = 'left:' + (x+ox) + 'px;top:' + (y+oy) + 'px;width:' + size + 'px;height:' + size + 'px;border-color:hsl(' + h + ',' + s + '%,' + l + '%);box-shadow:inset 0 0 6px rgba(114,151,244,0.3),0 0 8px rgba(114,151,244,0.2);animation-duration:' + dur + 's;';
        document.body.appendChild(b);
        setTimeout(function() { b.remove(); bubbleCount--; }, 1300);
    }
    ...
    function spawnBurstBubble(x, y) {
        ...
        var dist = Math.random() * 60 + 25;
        var size = Math.random() * 18 + 8;
        var h = 220 + Math.floor(Math.random() * 30 - 15);
        b.style.cssText = 'left:' + x + 'px;top:' + y + 'px;width:' + size + 'px;height:' + size + 'px;border-color:hsl(' + h + ',85%,70%);background:rgba(114,151,244,0.1);box-shadow:0 0 10px rgba(114,151,244,0.4);';
        document.body.appendChild(b);
        setTimeout(function() {
